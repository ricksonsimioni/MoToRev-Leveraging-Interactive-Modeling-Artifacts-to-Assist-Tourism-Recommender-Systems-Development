...
def generate_xmi_id_with_suffix(suffix="-kdKBnMBYA1g"):
    """Generates a random XMI ID with a fixed suffix."""
    random_part = uuid.uuid4().hex[:11]  # Generate a random 11-character string
    return f"_{random_part}{suffix}"
